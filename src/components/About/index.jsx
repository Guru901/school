...
const About = () => {
  return (
    <div className="about absolute-center">
      ...
      <div className="about-des absolute-center">
        <div className="about-paras">
          <p className="about-p-1">
            RPS is the Vibrant Organization which produces the Skillfull Descent
            and Knowledgible powerhouses of Enthusiasm, continuosly Devoloping
            in the field of Technological Advancements in Education as well as
            having the best sports facilities which ensures the fitness of our
            Future Genration.
          </p>
      ...
      <button id="about-us-read-more" className="cur-po">
        Read More
      </button>
